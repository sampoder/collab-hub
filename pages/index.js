    ...
    <Page>
      ...
      <Modal width="750pt" style={{ paddingTop: "-16pt" }} {...bindings}>
        <Modal.Content>
          ...
          <p>
            On COLLABORATION HUB, people don’t just post their own stuff -- we
            make things together. Whether you’re a beginner or an expert,
            whether you’re into writing, film, music, or any other kind of art,
            you’ll find this platform a welcoming and positive place to be your
            creative self.
          </p>
          <h2 style={{ fontSize: "1.5em", fontWeight: "600" }}>How it works</h2>
          <p>
            The COLLABORATION HUB is a new, interactive, sharing platform that
            allows students to be inspired by the work of others; REMIX and
            generate their own work; and share it on the HUB for others to be
            inspired further.
          </p>
          <p>
            This is an ARTS WEEK launch where everyone from artists, musicians,
            actors, singers, and dancers, to designers, editors, photographers,
            writers and coders can have a go. Just scroll through the samples in
            the gallery and remix it to make something (anything!) new from it.
          </p>
          <p>TIMELINE:</p>
          <p>
            The ARTS WEEK challenge will end on Friday 25 September the best
            collaborative creations will be shared in an assembly showcase and
            social media.
          </p>
          <p>
            Make sure you check emails and Google Currents for updates and
            ideas. We'll be featuring awesome contributions and REMIXES as we
            receive them and post them on this site, so make sure to check back
            to see what’s new.
          </p>
          ...
          <ol>
            <li>
              Explore the gallery of work shared on the homepage (Everything) or
              under the different section tabs above (Visual Arts, Photography,
              Music, Drama, Writing, Dance).
            </li>
            <li>Choose something that inspires you and MAKE SOMETHING NEW!</li>
          ...
          <p>See some cryptic CODE sequence for a piece of music? You could…</p>
          <ul>
          ...
          <p style={{ fontWeight: "600" }}>
            The options are endless...what can YOU do?
          </p>
        </Modal.Content>
